# Migration `20200601005853-activity-table-initial`

This migration has been generated by Nenye at 6/1/2020, 12:58:53 AM.
...
CREATE TABLE "public"."ActivityTimes" (
    "AM1" integer  NOT NULL DEFAULT 0,
    "AM10" integer  NOT NULL DEFAULT 0,
    "AM11" integer  NOT NULL DEFAULT 0,
    "AM12" integer  NOT NULL DEFAULT 0,
    "AM2" integer  NOT NULL DEFAULT 0,
    "AM3" integer  NOT NULL DEFAULT 0,
    "AM4" integer  NOT NULL DEFAULT 0,
    "AM5" integer  NOT NULL DEFAULT 0,
    "AM6" integer  NOT NULL DEFAULT 0,
    "AM7" integer  NOT NULL DEFAULT 0,
    "AM8" integer  NOT NULL DEFAULT 0,
    "AM9" integer  NOT NULL DEFAULT 0,
    "PM1" integer  NOT NULL DEFAULT 0,
    "PM10" integer  NOT NULL DEFAULT 0,
    "PM11" integer  NOT NULL DEFAULT 0,
    "PM12" integer  NOT NULL DEFAULT 0,
    "PM2" integer  NOT NULL DEFAULT 0,
    "PM3" integer  NOT NULL DEFAULT 0,
    "PM4" integer  NOT NULL DEFAULT 0,
    "PM5" integer  NOT NULL DEFAULT 0,
    "PM6" integer  NOT NULL DEFAULT 0,
    "PM7" integer  NOT NULL DEFAULT 0,
    "PM8" integer  NOT NULL DEFAULT 0,
    "PM9" integer  NOT NULL DEFAULT 0,
    "id" text  NOT NULL ,
    PRIMARY KEY ("id")
) 
...
migration 20200529161013-news-table-initial..20200601005853-activity-table-initial
--- datamodel.dml
+++ datamodel.dml
@@ -1,7 +1,7 @@
 datasource db {
